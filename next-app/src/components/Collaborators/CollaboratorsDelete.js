...
function CollaboratorsDelete({ reloadPage }) {
    ...
    const deleteCollaborator = async () => {
        try {
            const response = await fetch(`http://localhost:3008/api/collaborators/${dropdownId}`, {
              method: "DELETE",
              headers: {
            ...
            <Segment> 
                <Form>
                    ...
                    <br />
                    {
                        dropdownId !== "choice" ?
                            (
                                <Button onClick={deleteCollaborator} type='submit'>Delete</Button>
                            )
                        :
                            null
                    }
...
export default CollaboratorsDelete