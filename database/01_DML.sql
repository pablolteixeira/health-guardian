...
VALUES
    ...
    (2, 3233, '2023-07-01'),
    (3, 1444, '2023-09-01');
INSERT INTO Appointments (value, competence, company_id, name_benef, cpf, cod_procedure)
VALUES
    (548.75, '2023-09-01', 1, 'João Silva', '12345678901', 1001),
    (732.40, '2023-09-01', 1, 'Maria Oliveira', '98765432101', 1002),
    (613.20, '2023-08-01', 1, 'Carlos Santos', '23456789012', 1003),
    (895.15, '2023-08-01', 1, 'Ana Pereira', '34567890123', 1004),
    (421.90, '2023-07-01', 1, 'Fernanda Souza', '45678901234', 1005),
    (652.50, '2023-08-01', 2, 'Lucas Lima', '56789012345', 1006),
    (498.30, '2023-08-01', 2, 'Rafaela Oliveira', '67890123456', 1007),
    (713.80, '2023-07-01', 2, 'Mateus Silva', '78901234567', 1008),
